    ...
    const fetchMovieData = async () => {
        const suggestedForYou = await axios.get(
            `https://api.themoviedb.org/3/discover/movie?api_key=${
                ...
                user.favorite_genre
            }&language=en-US&primary_release_date.gte=2005&primary_release_date.lte=2022-11-01&region=US`
        );
        ...
        const originals = await axios.get(
            `https://api.themoviedb.org/3/discover/tv?api_key=${
                process.env.REACT_APP_MOVIEDB_API_KEY ||
                process.env.MOVIEDB_API_KEY
            }&language=en-US&sort_by=popularity.desc&page=1&vote_average.gte=6&with_status=0&with_type=4`
        );
